                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <FormInput disabled={true} title="Nilai Pagu (Rp)" name="pagu" value={formDataMandotary?.pagu?.toString()} placeholder="" />
                                    <FormInput disabled={true} title="Nilai HPS (Rp)" name="hps" value={formDataMandotary?.hps?.toString()} placeholder="" />
                                </div>
                            </div>
