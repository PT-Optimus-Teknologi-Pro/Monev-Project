                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <FormInput title="Kode RUP" name="" value={selectedTender?.kd_rup} placeholder="" disabled={true} />
                                    <FormInput title="Tahun Anggaran" name="" value={selectedTender?.tahun_anggaran.toString()} placeholder="" disabled={true} />

                                    <div className="md:col-span-2">
                                        <FormInput title="Satuan Kerja" name="" value={selectedTender?.nama_satker} placeholder="" disabled={true} />
                                    </div>

                                    {metodePengadaan == "Pengadaan Langsung" || metodePengadaan == "E-Purchasing V5" ? (
                                        <div className="md:col-span-2">
                                            <FormInput title="Nama Paket" name="" value={selectedTender?.nama_paket} placeholder="" disabled={true} />
                                        </div>
                                    ) : (
                                        <div className="md:col-span-2">
                                            <FormInput title="Nama Paket" name="" value={selectedTender?.rup_nama_pkt} placeholder="" disabled={true} />
                                        </div>
                                    )}

                                    {metodePengadaan == "Pengadaan Langsung" && (
                                        <FormInput title="Sumber Dana" name="" value={selectedTender?.sumber_dana} placeholder="" disabled={true} />
                                    )}
                                    {metodePengadaan == "E-Purchasing V5" && (
                                        <FormInput title="Sumber Dana" name="" value={selectedTender?.nama_sumber_dana} placeholder="" disabled={true} />
                                    )}
                                    {metodePengadaan == "E-Purchasing V6" && (
                                        <FormInput title="Sumber Dana" name="" value={selectedTender?.sumber_dana} placeholder="" disabled={true} />
                                    )}
                                    ...
                                    {!isEPurchasing && (
                                        <FormInput title="Jenis Pengadaan" name="" value={selectedTender?.jenis_pengadaan?.toString()} placeholder="" disabled={true} />
                                    )}
                                </div>
                            </div>
                            ...
                            {isEPurchasing && (
                                <div>
                                    ...
                                    {metodePengadaan == "E-Purchasing V5" ? (
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <FormInput title="Status Paket" value={selectedTender?.status_paket} name="" placeholder="" disabled={true} />
                                            <FormInput title="Status Pengiriman" value={selectedTender?.paket_status_str} name="" placeholder="" disabled={true} />
                                        </div>
                                    ) : (
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <FormInput title="Status Paket" value={selectedTender?.status_pkt} name="" placeholder="" disabled={true} />
                                            <FormInput title="Status Pengiriman" value={selectedTender?.status_pengiriman} name="" placeholder="" disabled={true} />
                                        </div>
                                    )}
                                </div>
                            )}
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Nilai Pagu (Rp)" name="pagu" value={formDataMandotary?.pagu} placeholder="" disabled={formDataMandotary?.pagu ? true : false} />
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Nilai HPS (Rp)" name="hps" value={formDataMandotary?.hps} placeholder="" disabled={formDataMandotary?.hps ? true : false} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <FormInput required={false} onChange={handleChangeMadotaryPenjabatPengadaan} title="Nomor Kontrak" name="no_kontrak" value={formDataMandotary?.no_kontrak} placeholder="" disabled={false} />
                                    <FormInput required={false} onChange={handleChangeMadotaryPenjabatPengadaan} title="Nilai Kontrak" name="nilai_kontrak" value={formDataMandotary?.nilai_kontrak} placeholder="" disabled={false} />
                                    <FormInput required={false} onChange={handleChangeMadotaryPenjabatPengadaan} type='date' title="Tanggal Kontrak" name="tgl_kontrak" value={formDataMandotary?.tgl_kontrak} placeholder="" disabled={false} />
                                    <FormInput required={false} onChange={handleChangeMadotaryPenjabatPengadaan} title="Nama PPK" name="nama_ppk" value={formDataMandotary?.nama_ppk} placeholder="" disabled={false} />
                                    <FormInput required={false} onChange={handleChangeMadotaryPenjabatPengadaan} title="Jabatan PPK" name="jabatan_ppk" value={formDataMandotary?.jabatan_ppk} placeholder="" disabled={false} />
                                    <FormInput required={false} onChange={handleChangeMadotaryPenjabatPengadaan} title="Nama Pimpinan Perusahaan" name="nama_pimpinan_perusahaan" value={formDataMandotary?.nama_pimpinan} placeholder="" disabled={false} />
                                    <FormInput required={false} onChange={handleChangeMadotaryPenjabatPengadaan} title="Jabatan Pimpinan" name="jabatan_pimpinan" value={formDataMandotary?.jabatan_pimpinan} placeholder="" disabled={false} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Pemenang" name="nama_penyedia" value={formDataMandotary.nama_penyedia} placeholder="" />
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Nilai Penawaran" name="nilai_penawaran" value={formDataMandotary?.nilai_penawaran} placeholder="" />
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Nilai Negosiasi" name="nilai_negosiasi" value={formDataMandotary?.nilai_negosiasi?.toString()} placeholder="" />
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Email" name="email" value={formDataMandotary?.email} placeholder="" />
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Nomor Telepon/HP" name="nomor_telp" value={formDataMandotary?.nomor_telp} placeholder="" />
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="NPWP" name="npwp_penyedia" value={formDataMandotary?.npwp_penyedia} placeholder="" />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Alamat Pemenang" value={formDataMandotary.alamat_pemenang} name="alamat_pemenang" placeholder="" />
                                    <FormInput onChange={handleChangeMadotaryPenjabatPengadaan} title="Lokasi Pekerjaan" name="lokasi_pekerjaan" value={formDataMandotary.lokasi_pekerjaan} placeholder="" />
                                </div>
                            </div>
