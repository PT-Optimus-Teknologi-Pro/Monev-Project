...
export default function PokjaLaporanKelompokAdd() {
    ...
    useEffect(() => {
        ...
        if (!tenderData || tenderData.length === 0) {
            ...
            options = uniqueMetode.map((name, index) => ({
                id: index + 1,
                name
            }));
        }
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <FormInput disabled={formDataMandotary?.pagu ? true : false} title="Nilai Pagu (Rp)" name="pagu" value={formDataMandotary.pagu} placeholder="" />
                                    <FormInput disabled={formDataMandotary?.hps ? true : false} title="Nilai HPS (Rp)" name="hps" value={formDataMandotary.hps} placeholder="" />
                                </div>
                            </div>
