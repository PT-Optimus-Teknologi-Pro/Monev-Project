...
export default function ForgotPassword() {
  const { handleRequestForgotPassword } = useUserHooks();
  const [email, setEmail] = useState('');
  const navigate = useNavigate();

  return (
    <div
      className="h-screen flex items-center justify-center p-4 overflow-hidden font-poppins-medium"
      style={{
    ...
    >
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-[14px]">Masukkan email Anda untuk menerima link reset password</p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <button
            type="button"
            onClick={() => handleRequestForgotPassword(email)}
