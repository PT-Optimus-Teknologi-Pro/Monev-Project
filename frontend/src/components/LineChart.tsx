...
export default function LineChart({ selectedRealization }: LineChartProps) {
    ...
    return (
        <div
            className="w-full min-h-screen bg-gradient-to-br from-hover/30 via-white to-blue-50/20"
            data-aos="fade-up"
        ...
        >
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-8 pt-24 sm:pt-28 pb-10 sm:pb-16">
                ...
                <div className="text-center mb-5 sm:mb-6">
                    <div className="inline-flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-hover to-blue-100 rounded-full mb-3">
                    ...
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-poppins-bold bg-gradient-to-r from-secondary via-third to-blue-500 bg-clip-text text-transparent mb-2 leading-tight">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-4 sm:p-6 border border-hover mb-4">
                    <div className="flex items-center space-x-2 mb-4">
                        <div className="w-1 h-6 bg-gradient-to-b from-third to-blue-500 rounded-full flex-shrink-0"></div>
                        <h2 className="text-base sm:text-lg font-poppins-bold text-gray-800 flex items-center space-x-2">
                            <TrendingUp className="h-4 w-4 sm:h-5 sm:w-5 text-third flex-shrink-0" />
                            <span>Kurva Progress</span>
                        </h2>
                    </div>

                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-3 sm:p-4 border border-gray-200 shadow-inner mb-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-0">
                        {/* Rencana */}
                        <div className="bg-gradient-to-br from-third to-secondary rounded-xl p-3 sm:p-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                                <p className="font-poppins-medium text-xs sm:text-sm opacity-90">Rencana</p>
                                <div className="w-7 h-7 sm:w-9 sm:h-9 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        {/* Aktual */}
                        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-3 sm:p-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                        ...
                        {/* Deviasi */}
                        <div className={`bg-gradient-to-br ${isAhead ? 'from-green-500 to-green-600' : 'from-red-500 to-red-600'} rounded-xl p-3 sm:p-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}>
                            <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-4 border border-hover hover:shadow-xl transition-all duration-300">
                        <div className="flex items-center space-x-3 mb-3">
                            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-third to-secondary rounded-lg flex items-center justify-center shadow-lg flex-shrink-0">
                        ...
                        <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                            <div className="h-full bg-gradient-to-r from-third to-secondary rounded-full animate-pulse transition-all duration-500" style={{ width: `${scheduleProgress}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-4 border border-blue-100 hover:shadow-xl transition-all duration-300">
                        <div className="flex items-center space-x-3 mb-3">
                            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg flex-shrink-0">
                    ...
                    {/* Detail Progress — spans 2 rows on lg */}
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-4 border border-purple-100 sm:col-span-2 lg:col-span-1 lg:row-span-2 hover:shadow-xl transition-all duration-300">
                        <div className="flex items-center space-x-2 mb-3">
                            <div className="w-1 h-6 bg-gradient-to-b from-purple-500 to-purple-600 rounded-full flex-shrink-0"></div>
                        ...
                        <div className="space-y-3">
                            {/* Perencanaan */}
                            <div className="bg-gradient-to-br from-hover to-hover/50 rounded-lg p-3">
                                <div className="flex items-center justify-between mb-2">
                                    <p className="font-poppins-semibold text-xs text-gray-700">Progress Perencanaan</p>
                                    <span className="font-poppins-bold text-sm sm:text-base text-secondary">{scheduleProgress.toFixed(1)}%</span>
                                </div>
                                <div className="relative h-2 bg-white rounded-full overflow-hidden shadow-inner">
                                    <div className="absolute inset-0 bg-gradient-to-r from-third to-secondary rounded-full transition-all duration-500" style={{ width: `${scheduleProgress}%` }}></div>
                                </div>
                            </div>
                            {/* Aktual */}
                            <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-lg p-3">
                                ...
                                <div className="relative h-2 bg-white rounded-full overflow-hidden shadow-inner">
                                    <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full transition-all duration-500" style={{ width: `${actualProgress}%` }}></div>
                                </div>
                            </div>
                            {/* Deviasi */}
                            <div className={`bg-gradient-to-br ${isAhead ? 'from-green-50 to-green-100/50' : 'from-red-50 to-red-100/50'} rounded-lg p-3`}>
                                <div className="flex items-center justify-between mb-2">
                                ...
                                <div className="relative h-2 bg-white rounded-full overflow-hidden shadow-inner">
                                    <div
                                        className={`absolute inset-0 bg-gradient-to-r ${isAhead ? 'from-green-400 to-green-600' : 'from-red-400 to-red-600'} rounded-full transition-all duration-500`}
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-4 sm:col-span-2 lg:col-span-2 border border-gray-200 hover:shadow-xl transition-all duration-300">
                        <div className="flex items-center space-x-2 mb-3">
                            <div className="w-1 h-6 bg-gradient-to-b from-indigo-500 to-indigo-600 rounded-full flex-shrink-0"></div>
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4">
                            ...
                            <div className="bg-gradient-to-br from-green-50 to-green-100/50 rounded-lg p-3 border border-green-200">
                                <div className="flex items-center space-x-2 mb-2">
                                    <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <div className="bg-gradient-to-br from-red-50 to-red-100/50 rounded-lg p-3 border border-red-200">
                                <div className="flex items-center space-x-2 mb-2">
                                    <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center flex-shrink-0">
                                        <Calendar className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-white" />
                                    </div>
